    ...
    >
      <div className="container-narrow text-center">
        <div
          ...
          style={{ backgroundColor: 'rgba(27,42,94,0.08)' }}
        >
          <CheckCircle size={32} style={{ color: 'var(--color-primary)' }} strokeWidth={1.5} />
        </div>
        <p className="eyebrow mb-4">Thank You</p>
        <h1 className="section-title mb-5" style={{ color: 'var(--color-text)' }}>
        ...
        <p className="font-serif text-base italic mb-10"
